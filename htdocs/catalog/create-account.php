<?php
    ...
    function signUp($u, $p){
        ...
        $conn = connectToDB();
            ...
            mysqli_close($conn);
            $msg = '<div class="col-12 text-center pt-2 pb-2 success bdr-25"><h2>You have successfully created an account</h2>
            </div><a class="mb-3 m-auto" href="/catalog">Sign in here</a>';
    ...
    function handleError(){
        ...
        $m = "";
        if(in_array(0, $e)) {
            $m.= "<li class='warning p-1'>Username already exists</li>";
            session_unset();
            session_destroy();
        }
        if(in_array(1, $e)) {
            $m.= "<li class='warning p-1'>Enter a username</li>";
        }
        if(in_array(2, $e)) {
            $m.= "<li class='warning p-1'>Enter a password</li>";
        }
        if(in_array(3, $e)){
            $m.= "<li class='warning p-1'>Verify your password</li>";
        } 
        if(in_array(4, $e)){
            $m.= "<li class='warning p-1'>Enter a username, password, and verify your password</li>";
        } 
        if(in_array(5, $e)){
            $m.= "<li class='warning p-1'>Passwords do not match</li>";
        }
        return $m;
    }
    ...
    if(!empty($_SESSION)){
        ...
        || str_ends_with($_SERVER['HTTP_REFERER'], "/catalog/")
        || str_ends_with($_SERVER['HTTP_REFERER'], "/catalog/index.php")) {
            session_unset(); 
            session_destroy();
        }
    ...
    function getDisplay($sub, $userName, $pass, $passV, $msg){
        ...
        if(!$sub || $msg == ""){
            $result .='
                <div class="card text-black my-5 bdr-25 bkg-grey">
                    <div class="card-body ">
                        <div class="row justify-content-center">
                            <div class="col-md-12 col-lg-8 col-xl-6 order-2 order-lg-1">
                                <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Sign up</p>
                                <ul class="list-unstyled text-center" id="pin"></ul>
                                <form action="" method="post">
                                    ...
                                    <div class="btn-toolbar justify-content-center">
                                        ...
                                        <button type="submit" name="sub" disabled id="sbt" class="text-center btn-primary btn-lg ml-1">Create Account</button>
                                    </div>
                                    <div class="row pt-3">
                                        <div class="col-12 text-center mt-2">
                                            <a class="" href="/catalog">Already a member? Sign in here.</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
                ...
                <div class="card text-black my-5 bdr-25 bkg-grey">
                    <div class="card-body ">
                        <div class="row justify-content-center">
                            <div class="col-md-12 col-lg-8 col-xl-6 order-2 order-lg-1">
                                <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Sign up</p>
                                <ul class="list-unstyled text-center" id="pin">'.$msg.'</ul>
                                <form action="" method="post">
                                    <div class="d-flex flex-row align-items-center mb-4">
                                        <i class="fas fa-user fa-lg me-3 fa-fw"></i>
                                        <div class="form-outline flex-fill mb-0">
