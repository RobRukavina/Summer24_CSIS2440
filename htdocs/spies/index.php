<?php 
    ...
    if(!empty($_SESSION)){
        ...
        if(isset($_SESSION["LAST_ACTIVITY"]) && !isset($_SESSION['log'])){
            session_unset();
            session_destroy();
        }
    ...
    if(isset($_POST['sbt'])){
        ...
        if(
            ...
            $ec = 2;
                ...
                (($userName != "chuck" && $pass != "roast")
                || ($userName == "chuck" && $pass != "roast")
                || ($userName != "chuck" && $pass == "roast"))
                &&
                ($userName != "bob" && $pass != "ross")
                || ($userName == "bob" && $pass != "ross")
                || ($userName != "bob" && $pass == "ross")
            ){
                $ec = 2;
    ...
    function getDisplay($userName, $pass, $valid, $msg, $ec, $sbt){
        ...
        if(!$sbt || $ec != 0){
            $res .= ($msg != "" ? "<div class='card mt-4'><div class='card-title text-center'>". $msg .="
                    </div>
                        <div class='card-body'>
                    ...
                    : 
                    "<div class='card mt-4'>
                        <div class='card-title text-center'><h1 class='bold white'>Login</h1>
